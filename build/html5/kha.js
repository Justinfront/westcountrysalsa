...
$hxClasses["kScenes.Wrapper"] = kScenes_Wrapper;
kScenes_Wrapper.__name__ = ["kScenes","Wrapper"];
kScenes_Wrapper.prototype = {
	alpha: null
	,x: null
	,y: null
	,ex: null
	...
	,off: function() {
		...
		case 1:
			...
			break;
		case 2:
			this.y = 768 + 1.5 * this.height;
			this.x = this.ex;
			break;
		case 3:
			this.x = 1024 + 1.5 * this.width;
			this.y = this.ey;
			break;
		case 4:
			this.x = this.ex;
...
var kScenes_ImageWrapper = function(image_,x_,y_) {
	if(y_ == null) {
		y_ = 0.;
	}
	if(x_ == null) {
	...
	this.image = image_;
	kScenes_Wrapper.call(this,this.image.get_width(),this.image.get_height(),x_,y_);
};
$hxClasses["kScenes.ImageWrapper"] = kScenes_ImageWrapper;
kScenes_ImageWrapper.__name__ = ["kScenes","ImageWrapper"];
kScenes_ImageWrapper.__super__ = kScenes_Wrapper;
kScenes_ImageWrapper.prototype = $extend(kScenes_Wrapper.prototype,{
	image: null
	,clone: function() {
		var imageWrapper = new kScenes_ImageWrapper(this.image,this.x,this.y);
		imageWrapper.alpha = this.alpha;
		return imageWrapper;
	}
...
kScenes_RectangleWrapper.prototype = $extend(kScenes_Wrapper.prototype,{
	...
	,__class__: kScenes_RectangleWrapper
});
var kScenes_Scene = function(sceneName_) {
...
$hxClasses["kScenes.Scene"] = kScenes_Scene;
kScenes_Scene.__name__ = ["kScenes","Scene"];
kScenes_Scene.prototype = {
	backRectangles: null
	,images: null
...
kScenes_SceneDirector.__name__ = ["kScenes","SceneDirector"];
...
kScenes_TextWrapper.__super__ = kScenes_Wrapper;
kScenes_TextWrapper.prototype = $extend(kScenes_Wrapper.prototype,{
	content: null
	,font: null
	,color: null
	,size: null
...
var kScenes_Compass = $hxClasses["kScenes.Compass"] = { __ename__ : true, __constructs__ : ["NORTH","WEST","SOUTH","EAST","CENTRE","NORTH_SMALL","WEST_SMALL","SOUTH_SMALL","EAST_SMALL","NORTH_WEST_SMALL","SOUTH_WEST_SMALL","SOUTH_EAST_SMALL","NORTH_EAST_SMALL"] };
kScenes_Compass.NORTH = ["NORTH",0];
kScenes_Compass.NORTH.toString = $estr;
kScenes_Compass.NORTH.__enum__ = kScenes_Compass;
kScenes_Compass.WEST = ["WEST",1];
kScenes_Compass.WEST.toString = $estr;
kScenes_Compass.WEST.__enum__ = kScenes_Compass;
kScenes_Compass.SOUTH = ["SOUTH",2];
kScenes_Compass.SOUTH.toString = $estr;
kScenes_Compass.SOUTH.__enum__ = kScenes_Compass;
kScenes_Compass.EAST = ["EAST",3];
kScenes_Compass.EAST.toString = $estr;
kScenes_Compass.EAST.__enum__ = kScenes_Compass;
kScenes_Compass.CENTRE = ["CENTRE",4];
kScenes_Compass.CENTRE.toString = $estr;
kScenes_Compass.CENTRE.__enum__ = kScenes_Compass;
kScenes_Compass.NORTH_SMALL = ["NORTH_SMALL",5];
kScenes_Compass.NORTH_SMALL.toString = $estr;
kScenes_Compass.NORTH_SMALL.__enum__ = kScenes_Compass;
kScenes_Compass.WEST_SMALL = ["WEST_SMALL",6];
kScenes_Compass.WEST_SMALL.toString = $estr;
kScenes_Compass.WEST_SMALL.__enum__ = kScenes_Compass;
kScenes_Compass.SOUTH_SMALL = ["SOUTH_SMALL",7];
kScenes_Compass.SOUTH_SMALL.toString = $estr;
kScenes_Compass.SOUTH_SMALL.__enum__ = kScenes_Compass;
kScenes_Compass.EAST_SMALL = ["EAST_SMALL",8];
kScenes_Compass.EAST_SMALL.toString = $estr;
kScenes_Compass.EAST_SMALL.__enum__ = kScenes_Compass;
kScenes_Compass.NORTH_WEST_SMALL = ["NORTH_WEST_SMALL",9];
kScenes_Compass.NORTH_WEST_SMALL.toString = $estr;
kScenes_Compass.NORTH_WEST_SMALL.__enum__ = kScenes_Compass;
kScenes_Compass.SOUTH_WEST_SMALL = ["SOUTH_WEST_SMALL",10];
kScenes_Compass.SOUTH_WEST_SMALL.toString = $estr;
kScenes_Compass.SOUTH_WEST_SMALL.__enum__ = kScenes_Compass;
kScenes_Compass.SOUTH_EAST_SMALL = ["SOUTH_EAST_SMALL",11];
kScenes_Compass.SOUTH_EAST_SMALL.toString = $estr;
kScenes_Compass.SOUTH_EAST_SMALL.__enum__ = kScenes_Compass;
kScenes_Compass.NORTH_EAST_SMALL = ["NORTH_EAST_SMALL",12];
...
kha__$Assets_ImageList.prototype = {
	...
	,RoseAndCrownLoad: function(done) {
		kha_Assets.loadImage("RoseAndCrown",function(image) {
			done();
		});
	}
	...
	,westCountryHomeDescription: null
	,westCountryHomeLoad: function(done) {
		kha_Assets.loadImage("westCountryHome",function(image) {
			done();
		});
	}
	,westCountryHomeUnload: function() {
		this.westCountryHome.unload();
		this.westCountryHome = null;
	}
	,westCountrySalsaPlain: null
	,westCountrySalsaPlainName: null
	,westCountrySalsaPlainDescription: null
	,westCountrySalsaPlainLoad: function(done) {
		kha_Assets.loadImage("westCountrySalsaPlain",function(image) {
			done();
		});
	}
	,westCountrySalsaPlainUnload: function() {
		this.westCountrySalsaPlain.unload();
		this.westCountrySalsaPlain = null;
	}
	,names: null
